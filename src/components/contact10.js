        ...
        <div className="contact10-content1 thq-flex-row">
          <div className="contact10-content2">
            <h2 className="thq-heading-2">
              {props.heading1 ?? (
                <Fragment>
                  <span className="contact10-text17">¡Contáctanos!</span>
                </Fragment>
              )}
            </h2>
              ...
              {props.content1 ?? (
                <Fragment>
                  <span className="contact10-text16">
                    Estamos aquí para ayudarte en tu inversión. ¡Déjanos tus
                    datos y nos pondremos en contacto contigo lo antes posible!
                  </span>
                </Fragment>
              )}
            </p>
        ...
        <div className="contact10-content3 thq-flex-row">
          <div className="contact10-container2">
            ...
            <h3 className="contact10-text12 thq-heading-3">
              {props.location1 ?? (
                <Fragment>
                  <span className="contact10-text18">Dirección:</span>
                </Fragment>
              )}
            </h3>
            <p className="thq-body-large">
          ...
          <div className="contact10-container4">
            ...
            <h3 className="contact10-text14 thq-heading-3">
              {props.location2 ?? (
                <Fragment>
                  <span className="contact10-text21">Teléfono:</span>
                </Fragment>
              )}
            </h3>
            <p className="thq-body-large">
              {props.location2Description ?? (
                <Fragment>
                  <span className="contact10-text19">+51 123 456 789</span>
                </Fragment>
              )}
            </p>
...
Contact10.defaultProps = {
  content1: undefined,
  location1ImageAlt: 'Oficina',
  location2ImageAlt: 'Teléfono',
  location2ImageSrc:
