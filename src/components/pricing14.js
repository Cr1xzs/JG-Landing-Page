              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <p className="thq-body-large">
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text158">Pago único</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                      ...
                      {props.plan1Feature1 ?? (
                        <Fragment>
                          <span className="pricing14-text199">
                            Terrenos disponibles en ubicaciones privilegiadas en
                            Chancay
                          </span>
                        </Fragment>
                      )}
                      ...
                      {props.plan1Feature2 ?? (
                        <Fragment>
                          <span className="pricing14-text200">
                            Excelente potencial de valorización con la
                      ...
                      {props.plan1Feature3 ?? (
                        <Fragment>
                          <span className="pricing14-text160">
                            Asesoramiento personalizado para maximizar tu
                            inversión
                          </span>
                        </Fragment>
                      )}
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  <p className="pricing14-text114 thq-body-large">
                    {props.plan2 ?? (
                      <Fragment>
                        <span className="pricing14-text190">Business plan</span>
                      </Fragment>
                    )}
                  </p>
                  ...
                  <p className="thq-body-large">
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text195">Pago anual</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                      ...
                      {props.plan2Feature1 ?? (
                        <Fragment>
                          <span className="pricing14-text194">
                            Diversidad de terrenos con diferentes metrajes
                            disponibles
                          </span>
                        </Fragment>
                      )}
                      ...
                      {props.plan2Feature2 ?? (
                        <Fragment>
                          <span className="pricing14-text182">
                            Acceso a información exclusiva sobre el desarrollo
                            del Megapuerto
                          </span>
                        </Fragment>
                      )}
                      ...
                      {props.plan3Feature4 ?? (
                        <Fragment>
                          <span className="pricing14-text198">
                            Acceso a eventos VIP y networking con otros
                            inversionistas
                          </span>
                        </Fragment>
                      )}
              ...
              <div className="pricing14-price16">
                <div className="pricing14-price17">
                  ...
                  <h3 className="pricing14-text132 thq-heading-3">
                    {props.plan1Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text192">$50,000</span>
                      </Fragment>
                    )}
                  </h3>
              ...
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  ...
                  <h3 className="pricing14-text139 thq-heading-3">
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text175">$100,000</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan2Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text166">$10,000</span>
                      </Fragment>
                    )}
                  </span>
                </div>
              ...
              <div className="pricing14-price20">
                <div className="pricing14-price21">
                  ...
                  <h3 className="pricing14-text147 thq-heading-3">
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text203">$200,000</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan3Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text197">$60,000</span>
                      </Fragment>
                    )}
                  </span>
                </div>
