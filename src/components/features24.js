          ...
          >
            ...
            <div className="features24-content3">
              <h2 className="thq-heading-2">
                {props.feature3Title ?? (
                  <Fragment>
                    <span className="features24-text5">Inversión segura</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
...
Features24.defaultProps = {
  ...
  feature3ImgAlt: 'Crecimiento de la zona',
  feature1ImgSrc:
  ...
  feature1ImgAlt: 'Imagen de terreno en Chancay',
  feature2ImgAlt: 'Ubicación cerca del Megapuerto',
