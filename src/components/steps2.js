          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Explore la conveniente ubicación de los terrenos en
                      Chancay, Perú, cerca del Megapuerto, lo que los convierte
            ...
            <div className="steps2-container5 thq-card">
              <h2 className="thq-heading-2">
                {props.step2Title ?? (
                  <Fragment>
                    <span className="steps2-text28">Invierta en el futuro</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text31">
                      Aproveche la oportunidad de invertir en un área en
                      crecimiento con la construcción del Megapuerto, lo que
                      aumentará el valor de su inversión a largo plazo.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text29">
                      Nuestro equipo de Judith Guarniz Bienes Raíces está listo
                      para brindarle asesoramiento profesional y personalizado
                      en cada paso del proceso de inversión.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text27">
                      No pierda la oportunidad de asegurar su terreno en Chancay
                      y ser parte de este emocionante proyecto. ¡Contáctenos
                      para reservar su espacio ahora!
                    </span>
                  </Fragment>
                )}
              </span>
