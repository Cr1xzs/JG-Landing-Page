      ...
      <div className="hero17-column thq-section-max-width thq-section-padding">
        <div className="hero17-content1">
          <h1 className="hero17-text1 thq-heading-1">
            {props.heading1 ?? (
              <Fragment>
                <span className="hero17-text8">Invierte en Chancay, Peru</span>
              </Fragment>
            )}
          </h1>
            ...
            {props.content1 ?? (
              <Fragment>
                <span className="hero17-text5">
                  Descubre la oportunidad de inversión en terrenos en Chancay,
                  Peru, con la construcción del Megapuerto. ¡No pierdas esta
                  oportunidad única para invertir en un proyecto de gran
                  envergadura!
                </span>
              </Fragment>
            )}
        ...
        <div className="hero17-actions">
          <button className="thq-button-filled hero17-button1">
            <span className="thq-body-small">
              {props.action1 ?? (
                <Fragment>
                  <span className="hero17-text6">Contacta Ahora</span>
                </Fragment>
              )}
            </span>
          </button>
          <button className="thq-button-outline hero17-button2">
            <span className="thq-body-small">
              {props.action2 ?? (
                <Fragment>
                  <span className="hero17-text7">Más Información</span>
                </Fragment>
              )}
            </span>
          </button>
